...
export default function App() {
  ...
  const onToggleShortlist = flags.smartRendering
    ? toggleStable
    : toggleUnstable;
    ...
    <Fragment>
      ...
      <div className="shell">
        <header className="topbar glass-panel glass-panel--hero">
          <div className="topbar__copy">
            ...
            <p className="topbar__sub">
              Four switches, one viewport. Watch commit cost and row paints
              respond — built for demos, tuned like a product surface.
            </p>
          </div>
        ...
        <section className="metrics-row glass-panel" aria-label="Metrics">
          ...
          <div className="metric-pill">
            ...
            <span className="metric-pill__value">
              {cars.length.toLocaleString("en-IN")}
            </span>
          </div>
          <div className="metric-pill">
        ...
        <div className="layout layout--fill">
          ...
          <section
            className="catalog glass-panel catalog--fill"
            aria-label="List"
          >
            ...
            {flags.stress && !flags.virtualize && filteredCars.length > 200 ? (
              <p className="catalog__warn" role="status">
                Full DOM ({filteredCars.length.toLocaleString("en-IN")} rows) —
                enable <strong>Virtual list</strong> for smooth scrolling.
              </p>
            ) : null}
        ...
        <footer className="footer">
          Pulse is isolated in its pill — it does not re-render the chart or
          list. Strict Mode off for predictable counts.
        </footer>
      </div>
    </Fragment>
  );
